...
export abstract class Scene {
    ...
    public abstract draw(deltaTime: number): Boolean; // Here will draw the scene (deltaTime is the difference in time between this frame and the past frame in milliseconds)
...
export default class Game {
    ...
    private loop(time: DOMHighResTimeStamp){
        ...
        if(this.currentScene != null){
           let states = this.currentScene.draw(time-this.lastTick);
           if (states == true) {
