...
import maze from './scenes/mazeGame';
import mazePoint from './scenes/mazeGamePoint';
import mazeWithoutLight from './scenes/MazeWithoutLight'
...
const scenes = {
    ...
    "Maze": maze,
    "MazePoint":mazePoint,
    "mazeWithoutLight":mazeWithoutLight
};
const initialScene = "MazePoint";
